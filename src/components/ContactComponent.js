...
import { Breadcrumb, BreadcrumbItem, Button, Row, 
...
class Contact extends Component {
    constructor(props) {
        super(props);
        // Mandatory binding for the handler functions (in class-based components) or the form won't work! 
        this.handleSubmit = this.handleSubmit.bind(this);
    }

    // Submit values and add them to the BE
    handleSubmit(values) {
        console.log('Current State is: ' + JSON.stringify(values));
        alert('Current State is: ' + JSON.stringify(values));
        // Not needed with React Redux Form 
                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            ...
                            <a role="button" className="btn btn-info" href="something"><i className="fa fa-skype"></i> Skype</a>
